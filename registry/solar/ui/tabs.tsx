...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 text-body-compact outline-none", className)}
      {...props}
    />
  )
}
