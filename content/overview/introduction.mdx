  ...
  <Do label="Do — same height">
    <div className="flex w-full max-w-xs gap-2">
      <input
        ...
        className="h-field w-full min-w-0 rounded-field border border-transparent px-3 text-label font-light tracking-[0.4px] outline-none placeholder:text-default-11 text-default-12 [background:linear-gradient(to_top,var(--color-default-2),var(--color-default-1))_padding-box,linear-gradient(to_bottom,var(--color-default-8),var(--color-default-6))_border-box]"
      />
